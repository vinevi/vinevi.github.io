---
title: Might and Magic 6 Glitches
...
Data affected by 5th slot:
https://docs.google.com/spreadsheets/d/1S2NUpGPmsXoLPuPY117Ws7Vzqr3JirfJKkctUYt1mm8/edit?usp=sharing
...
1. Kill the party
Killing the party will get rid of the debuffs / buffs and resurrect the Knight allowing party to travel freely without crashing.
2. Use master healer or temple to resurrect the Knight. However since the buffs are still on, map crossing / resting / training will crash the game. Buffed Knight is about two times stronger.  
*After healing the Knight will have 150hp. This is much lower than what he can have. If you were to get rid of all the debuffs and update his stats, his hp will be around 100k. Using LVL well at Kriegspire updates the HP back to normal even if the Knight is buffed, resting after dying does too.*
...
3. Take Enchant Item scroll, press ESC --> Save Game and use it here
4. Start a new game
...
That is why the only new follower it is possible to get is a follower made of 2 normal ones (not of quest type):
99 Helen Teal
...
2. Swap the 4th slot twice (ctrl+click when no one has a turn)
*Sometimes the image won't update so you'd need to move a little.*
3. Swap again once
